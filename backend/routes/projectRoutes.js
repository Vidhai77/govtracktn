...
router.route('/district/:district')
  .get(protect, getProjectsByDistrict); // Public, req.user optional
...
router.route('/tenderer/:tenderer')
  .get(protect, getProjectsByTenderer); // Public, req.user optional

router.route('/:id/assign-tenderer')
  .put(protect, assignProjectToTenderer); // Public, req.user optional
